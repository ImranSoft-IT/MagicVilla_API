    ...
    public class VillaNumberAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetVillaNumber(int id)
        {
            try
            {
                ...
                VillaNumber villaNum = await _villaNumberRepository.GetAsync(n => n.VillaNo == id, tracked: false, includeProperties: "Villa");
                if (villaNum == null)
                {
        ...
        public async Task<ActionResult<APIResponse>> CreateVillaNumber([FromBody] VillaNumberCreateDTO createNumDTO)
        {
            try
            {
                if (await _villaNumberRepository.GetAsync(x => x.VillaNo == createNumDTO.VillaNo) != null)
                {
